...
public class Exceptions03 {
    ...
    public static void main(String[] args) throws IllegalGreatException {
        printGrades(60);
    ...
    public static void printGrades(double grade) throws IllegalGreatException {
        if(grade<0 || grade>100){
            throw new IllegalGreatException("Grade 0 dan az 100 den cok olamaz");
        }else{
